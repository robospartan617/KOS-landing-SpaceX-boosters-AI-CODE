...
function LandThrottle {		// throttle for landing
	...
	local stopDist is vertSpd^2 / (2 * shipAcc).

	// Return throttle fraction needed to stop by the time we reach the ground.
	// bottomaltradar = distance from engines to ground (more accurate than alt:radar).
